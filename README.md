...
### [⬇️ Download for macOS (Apple Silicon)](https://github.com/tommasinigiovanni/claude-code-dashboard/releases/latest/download/Claude.Code.Dashboard_0.6.0_aarch64.dmg)
